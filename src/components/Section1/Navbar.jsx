...
const Navbar = () => {
  return (
    <div className="flex items-center justify-between py-3 px-4 sm:px-8 md:px-18 bg-gray-950">
        <h4 className=" bg-emerald-600 hover:bg-emerald-900 text-xs sm:text-s font-bold text-white px-3 sm:px-6 py-2 rounded-full transition">
            Target Audience
        </h4>
